...
type ListFeedbackReq struct {
	...
	PaginationOptions *basic.PaginationOptions `protobuf:"bytes,1,opt,name=paginationOptions,proto3" form:"paginationOptions" json:"paginationOptions" query:"paginationOptions"` // 分页参数
	Type              *int64                   `protobuf:"varint,2,opt,name=type,proto3,oneof" form:"type" json:"type" query:"type"`                                              // 可选的反馈类型过滤
	UserId            *string                  `protobuf:"bytes,3,opt,name=userId,proto3,oneof" form:"userId" json:"userId" query:"userId"`                                       // 可选的用户ID过滤
}
...
func (x *ListFeedbackReq) GetPaginationOptions() *basic.PaginationOptions {
	if x != nil {
		return x.PaginationOptions
	}
	return nil
...
func (x *ListFeedbackReq) GetType() int64 {
	if x != nil && x.Type != nil {
		return *x.Type
	}
	return 0
...
type ListFeedbackResp struct {
	...
	Feedbacks []*ListFeedbackResp_FeedbackItem `protobuf:"bytes,4,rep,name=feedbacks,proto3" form:"feedbacks" json:"feedbacks" query:"feedbacks"` // 反馈列表
}
...
func (x *ListFeedbackResp) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ListFeedbackResp) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
func (x *ListFeedbackResp) GetFeedbacks() []*ListFeedbackResp_FeedbackItem {
	if x != nil {
		return x.Feedbacks
	}
	return nil
...
type ListFeedbackResp_FeedbackItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Images     []string `protobuf:"bytes,4,rep,name=images,proto3" form:"images" json:"images" query:"images"`
	CreateTime string   `protobuf:"bytes,5,opt,name=createTime,proto3" form:"createTime" json:"createTime" query:"createTime"`
	Status     string   `protobuf:"bytes,6,opt,name=status,proto3" form:"status" json:"status" query:"status"` // 状态
}

func (x *ListFeedbackResp_FeedbackItem) Reset() {
	*x = ListFeedbackResp_FeedbackItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListFeedbackResp_FeedbackItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListFeedbackResp_FeedbackItem) ProtoMessage() {}

func (x *ListFeedbackResp_FeedbackItem) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[50]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListFeedbackResp_FeedbackItem.ProtoReflect.Descriptor instead.
func (*ListFeedbackResp_FeedbackItem) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{45, 0}
}

func (x *ListFeedbackResp_FeedbackItem) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListFeedbackResp_FeedbackItem) GetType() int64 {
	if x != nil {
		return x.Type
	}
	return 0
...
func (x *ListFeedbackResp_FeedbackItem) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *ListFeedbackResp_FeedbackItem) GetImages() []string {
	if x != nil {
		return x.Images
	}
	return nil
...
func (x *ListFeedbackResp_FeedbackItem) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
func (x *ListFeedbackResp_FeedbackItem) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_essay_show_common_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x22, 0x3d, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x44, 0x61, 0x69, 0x6c, 0x79, 0x41,
	0x74, 0x74, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x79, 0x65, 0x61, 0x72,
	...
	,
	...
	0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x3f, 0x0a, 0x15, 0x46, 0x69, 0x6c, 0x6c, 0x49, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xa4, 0x01, 0x0a, 0x10, 0x45, 0x73, 0x73, 0x61,
	...
	0x09, 0x52, 0x03, 0x6f, 0x63, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x67, 0x72, 0x61, 0x64, 0x65,
	0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x65, 0x73, 0x73, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x22, 0x65,
	0x0a, 0x11, 0x45, 0x73, 0x73, 0x61, 0x79, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x65, 0x52,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x73,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x35, 0x0a, 0x0f, 0x4c, 0x69, 0x6b, 0x65, 0x45, 0x76, 0x61,
	...
	0x52, 0x04, 0x6c, 0x6f, 0x67, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x03, 0x4c, 0x6f, 0x67, 0x12, 0x0e,
	...
	0x65, 0x22, 0x33, 0x0a, 0x07, 0x4f, 0x43, 0x52, 0x52, 0x65, 0x73, 0x70, 0x12, 0x14, 0x0a, 0x05,
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74,
	0x6c, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x22, 0x30, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0xa3, 0x01, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x17, 0x0a, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x04, 0x74, 0x79, 0x70,
	...
	0x01, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x75,
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xb6, 0x02, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x65,
	0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f,
	...
	0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x47, 0x0a, 0x09, 0x66, 0x65, 0x65, 0x64, 0x62, 0x61,
	0x63, 0x6b, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x65, 0x73, 0x73, 0x61,
	0x79, 0x2e, 0x73, 0x68, 0x6f, 0x77, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x65, 0x65, 0x64, 0x62,
	0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b,
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x09, 0x66, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x73, 0x1a,
	0x9c, 0x01, 0x0a, 0x0c, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x49, 0x74, 0x65, 0x6d,
	...
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x71,
...
var file_essay_show_common_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_essay_show_common_proto_goTypes = []interface{}{
	...
	(*ListFeedbackReq)(nil),                        // 44: essay.show.ListFeedbackReq
	(*ListFeedbackResp)(nil),                       // 45: essay.show.ListFeedbackResp
	...
	(*ListFeedbackResp_FeedbackItem)(nil),          // 50: essay.show.ListFeedbackResp.FeedbackItem
...
var file_essay_show_common_proto_depIdxs = []int32{
	...
	51, // 1: essay.show.GetEssayEvaluateLogsReq.paginationOptions:type_name -> basic.PaginationOptions
	...
	51, // 4: essay.show.ListSimpleExercisesReq.paginationOptions:type_name -> basic.PaginationOptions
	...
	51, // 15: essay.show.ListFeedbackReq.paginationOptions:type_name -> basic.PaginationOptions
	50, // 16: essay.show.ListFeedbackResp.feedbacks:type_name -> essay.show.ListFeedbackResp.FeedbackItem
	47, // 17: essay.show.ListSimpleExercisesResp.SimpleExercise.records:type_name -> essay.show.ListSimpleExercisesResp.Record
...
func file_essay_show_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_essay_show_common_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListFeedbackResp_FeedbackItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_essay_show_common_proto_msgTypes[44].OneofWrappers = []interface{}{}
	type x struct{}
