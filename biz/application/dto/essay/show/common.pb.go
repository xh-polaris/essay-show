...
type SignUpReq struct {
	...
	Password string `protobuf:"bytes,3,opt,name=password,proto3" form:"password" json:"password" query:"password"` // 需要MD5加密
}
...
type EssayEvaluateResp struct {
	...
	Response *EvaluateResponse `protobuf:"bytes,3,opt,name=response,proto3" form:"response" json:"response" query:"response"`
}
...
type GetEssayEvaluateLogsResp struct {
	...
	Responses []*EvaluateResponse `protobuf:"bytes,2,rep,name=responses,proto3" form:"responses" json:"responses" query:"responses"`
}
...
var file_essay_show_common_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x42, 0x71, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e,
