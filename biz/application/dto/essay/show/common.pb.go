...
type EssayEvaluateReq struct {
	...
	Ocr   string `protobuf:"bytes,4,opt,name=ocr,proto3" form:"ocr" json:"ocr" query:"ocr"`
}
...
type Log struct {
	...
	Ocr        string `protobuf:"bytes,3,opt,name=ocr,proto3" form:"ocr" json:"ocr" query:"ocr"`
...
var file_essay_show_common_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x71, 0x0a,
