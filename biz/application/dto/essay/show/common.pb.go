...
type GetDailyAttendResp struct {
	...
	Code   int64  `protobuf:"varint,1,opt,name=code,proto3" form:"code" json:"code" query:"code"`
	Msg    string `protobuf:"bytes,2,opt,name=msg,proto3" form:"msg" json:"msg" query:"msg"`
	Attend int64  `protobuf:"varint,3,opt,name=attend,proto3" form:"attend" json:"attend" query:"attend"`
}
...
type SubmitFeedbackReq struct {
	...
	Type        int32    `protobuf:"varint,1,opt,name=type,proto3" form:"type" json:"type" query:"type"`                            // 反馈类型：1-建议，2-错误报告，3-功能请求，4-其他
	Content     string   `protobuf:"bytes,2,opt,name=content,proto3" form:"content" json:"content" query:"content"`                 // 反馈内容
	ContactInfo string   `protobuf:"bytes,3,opt,name=contactInfo,proto3" form:"contactInfo" json:"contactInfo" query:"contactInfo"` // 联系方式（可选）
	Images      []string `protobuf:"bytes,4,rep,name=images,proto3" form:"images" json:"images" query:"images"`                     // 图片URL列表（可选）
	RelatedId   string   `protobuf:"bytes,5,opt,name=relatedId,proto3" form:"relatedId" json:"relatedId" query:"relatedId"`         // 相关资源ID（可选）
}
...
func (x *SubmitFeedbackReq) GetContactInfo() string {
	if x != nil {
...
func (x *SubmitFeedbackReq) GetRelatedId() string {
	if x != nil {
		return x.RelatedId
	}
	return ""
...
type SubmitFeedbackResp struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" form:"id" json:"id" query:"id"` // 反馈ID
}
...
func (x *SubmitFeedbackResp) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
// 获取用户反馈列表请求
type GetUserFeedbacksReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Page  int64 `protobuf:"varint,1,opt,name=page,proto3" form:"page" json:"page" query:"page"`     // 页码，从1开始
	Limit int64 `protobuf:"varint,2,opt,name=limit,proto3" form:"limit" json:"limit" query:"limit"` // 每页数量
}

func (x *GetUserFeedbacksReq) Reset() {
	*x = GetUserFeedbacksReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserFeedbacksReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserFeedbacksReq) ProtoMessage() {}

func (x *GetUserFeedbacksReq) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserFeedbacksReq.ProtoReflect.Descriptor instead.
func (*GetUserFeedbacksReq) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{45}
}

func (x *GetUserFeedbacksReq) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetUserFeedbacksReq) GetLimit() int64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type FeedbackInfo struct {
	...
	Id         string   `protobuf:"bytes,1,opt,name=id,proto3" form:"id" json:"id" query:"id"`                                 // 反馈ID
	Type       int32    `protobuf:"varint,2,opt,name=type,proto3" form:"type" json:"type" query:"type"`                        // 反馈类型
	Content    string   `protobuf:"bytes,3,opt,name=content,proto3" form:"content" json:"content" query:"content"`             // 反馈内容
	Status     int32    `protobuf:"varint,4,opt,name=status,proto3" form:"status" json:"status" query:"status"`                // 处理状态：0-待处理，1-处理中，2-已解决，3-已拒绝
	Reply      string   `protobuf:"bytes,5,opt,name=reply,proto3" form:"reply" json:"reply" query:"reply"`                     // 管理员回复
	Images     []string `protobuf:"bytes,6,rep,name=images,proto3" form:"images" json:"images" query:"images"`                 // 图片URL列表
	RelatedId  string   `protobuf:"bytes,7,opt,name=relatedId,proto3" form:"relatedId" json:"relatedId" query:"relatedId"`     // 相关资源ID
	CreateTime string   `protobuf:"bytes,8,opt,name=createTime,proto3" form:"createTime" json:"createTime" query:"createTime"` // 创建时间
	UpdateTime string   `protobuf:"bytes,9,opt,name=updateTime,proto3" form:"updateTime" json:"updateTime" query:"updateTime"` // 更新时间
}

func (x *FeedbackInfo) Reset() {
	*x = FeedbackInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *FeedbackInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FeedbackInfo) ProtoMessage() {}

func (x *FeedbackInfo) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[46]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FeedbackInfo.ProtoReflect.Descriptor instead.
func (*FeedbackInfo) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{46}
}

func (x *FeedbackInfo) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *FeedbackInfo) GetType() int32 {
	if x != nil {
		return x.Type
	}
	return 0
...
func (x *FeedbackInfo) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *FeedbackInfo) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *FeedbackInfo) GetReply() string {
	if x != nil {
		return x.Reply
	}
	return ""
...
func (x *FeedbackInfo) GetImages() []string {
	if x != nil {
		return x.Images
	}
	return nil
...
func (x *FeedbackInfo) GetRelatedId() string {
	if x != nil {
		return x.RelatedId
	}
	return ""
...
func (x *FeedbackInfo) GetCreateTime() string {
	if x != nil {
		return x.CreateTime
	}
	return ""
...
func (x *FeedbackInfo) GetUpdateTime() string {
	if x != nil {
		return x.UpdateTime
	}
	return ""
...
// 获取用户反馈列表响应
type GetUserFeedbacksResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Feedbacks []*FeedbackInfo `protobuf:"bytes,1,rep,name=feedbacks,proto3" form:"feedbacks" json:"feedbacks" query:"feedbacks"` // 反馈列表
	Total     int64           `protobuf:"varint,2,opt,name=total,proto3" form:"total" json:"total" query:"total"`                // 总数量
}

func (x *GetUserFeedbacksResp) Reset() {
	*x = GetUserFeedbacksResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserFeedbacksResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserFeedbacksResp) ProtoMessage() {}

func (x *GetUserFeedbacksResp) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[47]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserFeedbacksResp.ProtoReflect.Descriptor instead.
func (*GetUserFeedbacksResp) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{47}
}

func (x *GetUserFeedbacksResp) GetFeedbacks() []*FeedbackInfo {
	if x != nil {
		return x.Feedbacks
	}
	return nil
...
func (x *GetUserFeedbacksResp) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *GetFeedbackDetailReq) Reset() {
	*x = GetFeedbackDetailReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetFeedbackDetailReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFeedbackDetailReq) ProtoMessage() {}

func (x *GetFeedbackDetailReq) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[48]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFeedbackDetailReq.ProtoReflect.Descriptor instead.
func (*GetFeedbackDetailReq) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{48}
}

func (x *GetFeedbackDetailReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type GetFeedbackDetailResp struct {
	...
	Feedback *FeedbackInfo `protobuf:"bytes,1,opt,name=feedback,proto3" form:"feedback" json:"feedback" query:"feedback"` // 反馈详情
}

func (x *GetFeedbackDetailResp) Reset() {
	*x = GetFeedbackDetailResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetFeedbackDetailResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFeedbackDetailResp) ProtoMessage() {}

func (x *GetFeedbackDetailResp) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFeedbackDetailResp.ProtoReflect.Descriptor instead.
func (*GetFeedbackDetailResp) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{49}
}

func (x *GetFeedbackDetailResp) GetFeedback() *FeedbackInfo {
	if x != nil {
		return x.Feedback
	}
	return nil
...
type UpdateFeedbackStatusReq struct {
	...
	Id     string `protobuf:"bytes,1,opt,name=id,proto3" form:"id" json:"id" query:"id"`                  // 反馈ID
	Status int32  `protobuf:"varint,2,opt,name=status,proto3" form:"status" json:"status" query:"status"` // 新状态：0-待处理，1-处理中，2-已解决，3-已拒绝
}

func (x *UpdateFeedbackStatusReq) Reset() {
	*x = UpdateFeedbackStatusReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateFeedbackStatusReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateFeedbackStatusReq) ProtoMessage() {}

func (x *UpdateFeedbackStatusReq) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[50]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateFeedbackStatusReq.ProtoReflect.Descriptor instead.
func (*UpdateFeedbackStatusReq) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{50}
}

func (x *UpdateFeedbackStatusReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *UpdateFeedbackStatusReq) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
// 更新反馈状态响应
type UpdateFeedbackStatusResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Success bool `protobuf:"varint,1,opt,name=success,proto3" form:"success" json:"success" query:"success"` // 是否成功
}

func (x *UpdateFeedbackStatusResp) Reset() {
	*x = UpdateFeedbackStatusResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateFeedbackStatusResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateFeedbackStatusResp) ProtoMessage() {}

func (x *UpdateFeedbackStatusResp) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[51]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateFeedbackStatusResp.ProtoReflect.Descriptor instead.
func (*UpdateFeedbackStatusResp) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{51}
}

func (x *UpdateFeedbackStatusResp) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
type ReplyFeedbackReq struct {
	...
	Id     string `protobuf:"bytes,1,opt,name=id,proto3" form:"id" json:"id" query:"id"`                  // 反馈ID
	Reply  string `protobuf:"bytes,2,opt,name=reply,proto3" form:"reply" json:"reply" query:"reply"`      // 回复内容
	Status int32  `protobuf:"varint,3,opt,name=status,proto3" form:"status" json:"status" query:"status"` // 更新状态（可选）：0-待处理，1-处理中，2-已解决，3-已拒绝
}

func (x *ReplyFeedbackReq) Reset() {
	*x = ReplyFeedbackReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplyFeedbackReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplyFeedbackReq) ProtoMessage() {}

func (x *ReplyFeedbackReq) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplyFeedbackReq.ProtoReflect.Descriptor instead.
func (*ReplyFeedbackReq) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{52}
}

func (x *ReplyFeedbackReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ReplyFeedbackReq) GetReply() string {
	if x != nil {
		return x.Reply
	}
	return ""
...
func (x *ReplyFeedbackReq) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ReplyFeedbackResp) Reset() {
	*x = ReplyFeedbackResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplyFeedbackResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplyFeedbackResp) ProtoMessage() {}

func (x *ReplyFeedbackResp) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplyFeedbackResp.ProtoReflect.Descriptor instead.
func (*ReplyFeedbackResp) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{53}
}

func (x *ReplyFeedbackResp) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
// 获取所有反馈列表请求
type GetAllFeedbacksReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Page   int64 `protobuf:"varint,1,opt,name=page,proto3" form:"page" json:"page" query:"page"`         // 页码，从1开始
	Limit  int64 `protobuf:"varint,2,opt,name=limit,proto3" form:"limit" json:"limit" query:"limit"`     // 每页数量
	Type   int32 `protobuf:"varint,3,opt,name=type,proto3" form:"type" json:"type" query:"type"`         // 筛选类型（可选）：0-全部，1-建议，2-错误报告，3-功能请求，4-其他
	Status int32 `protobuf:"varint,4,opt,name=status,proto3" form:"status" json:"status" query:"status"` // 筛选状态（可选）：-1-全部，0-待处理，1-处理中，2-已解决，3-已拒绝
}

func (x *GetAllFeedbacksReq) Reset() {
	*x = GetAllFeedbacksReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllFeedbacksReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllFeedbacksReq) ProtoMessage() {}

func (x *GetAllFeedbacksReq) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[54]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllFeedbacksReq.ProtoReflect.Descriptor instead.
func (*GetAllFeedbacksReq) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{54}
}

func (x *GetAllFeedbacksReq) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetAllFeedbacksReq) GetLimit() int64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GetAllFeedbacksReq) GetType() int32 {
	if x != nil {
		return x.Type
	}
	return 0
...
func (x *GetAllFeedbacksReq) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
// 获取所有反馈列表响应
type GetAllFeedbacksResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAllFeedbacksResp) Reset() {
	*x = GetAllFeedbacksResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllFeedbacksResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllFeedbacksResp) ProtoMessage() {}

func (x *GetAllFeedbacksResp) ProtoReflect() protoreflect.Message {
	mi := &file_essay_show_common_proto_msgTypes[55]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllFeedbacksResp.ProtoReflect.Descriptor instead.
func (*GetAllFeedbacksResp) Descriptor() ([]byte, []int) {
	return file_essay_show_common_proto_rawDescGZIP(), []int{55}
}

func (x *GetAllFeedbacksResp) GetFeedbacks() []*FeedbackInfo {
	if x != nil {
		return x.Feedbacks
	}
	return nil
...
func (x *GetAllFeedbacksResp) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_essay_show_common_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x72, 0x22, 0x65, 0x0a, 0x11, 0x45, 0x73, 0x73, 0x61, 0x79, 0x45, 0x76, 0x61, 0x6c, 0x75,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x35, 0x0a, 0x0f, 0x4c, 0x69, 0x6b,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x99, 0x01, 0x0a, 0x11, 0x53,
	...
	0x0a, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20,
	...
	0x52, 0x06, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x6c, 0x61,
	0x74, 0x65, 0x64, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x6c,
	0x61, 0x74, 0x65, 0x64, 0x49, 0x64, 0x22, 0x24, 0x0a, 0x12, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74,
	0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x3f, 0x0a, 0x13,
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x73,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0xf0, 0x01,
	0x0a, 0x0c, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x6d,
	0x61, 0x67, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x49, 0x64, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x49, 0x64,
	...
	,
	...
	0x22, 0x34, 0x0a, 0x18, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61,
	0x63, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07,
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73,
	0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x50, 0x0a, 0x10, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x46,
	0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2d, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x12, 0x18, 0x0a,
	0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07,
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x6a, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x41, 0x6c,
	0x6c, 0x46, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x73, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a,
	...
	0x74, 0x75, 0x73, 0x22, 0x63, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x46, 0x65, 0x65,
	0x64, 0x62, 0x61, 0x63, 0x6b, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x36, 0x0a, 0x09, 0x66, 0x65,
	0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	0x65, 0x73, 0x73, 0x61, 0x79, 0x2e, 0x73, 0x68, 0x6f, 0x77, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x62,
	0x61, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x09, 0x66, 0x65, 0x65, 0x64, 0x62, 0x61, 0x63,
	0x6b, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x71, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x73, 0x2f, 0x65, 0x73, 0x73, 0x61, 0x79, 0x2d, 0x73, 0x68, 0x6f, 0x77, 0x2f, 0x62, 0x69, 0x7a,
...
var file_essay_show_common_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_essay_show_common_proto_goTypes = []interface{}{
	...
	(*DailyAttendReq)(nil),                         // 9: essay.show.DailyAttendReq
	(*GetDailyAttendReq)(nil),                      // 10: essay.show.GetDailyAttendReq
	(*GetDailyAttendResp)(nil),                     // 11: essay.show.GetDailyAttendResp
	(*GetInvitationCodeReq)(nil),                   // 12: essay.show.GetInvitationCodeReq
	(*GetInvitationCodeResp)(nil),                  // 13: essay.show.GetInvitationCodeResp
	(*FillInvitationCodeReq)(nil),                  // 14: essay.show.FillInvitationCodeReq
	(*EssayEvaluateReq)(nil),                       // 15: essay.show.EssayEvaluateReq
	(*EssayEvaluateResp)(nil),                      // 16: essay.show.EssayEvaluateResp
	(*LikeEvaluateReq)(nil),                        // 17: essay.show.LikeEvaluateReq
	(*GetEssayEvaluateLogsReq)(nil),                // 18: essay.show.GetEssayEvaluateLogsReq
	(*GetEssayEvaluateLogsResp)(nil),               // 19: essay.show.GetEssayEvaluateLogsResp
	(*Log)(nil),                                    // 20: essay.show.Log
	(*ApplySignedUrlReq)(nil),                      // 21: essay.show.ApplySignedUrlReq
	(*ApplySignedUrlResp)(nil),                     // 22: essay.show.ApplySignedUrlResp
	(*OCRReq)(nil),                                 // 23: essay.show.OCRReq
	(*OCRResp)(nil),                                // 24: essay.show.OCRResp
	(*Response)(nil),                               // 25: essay.show.Response
	(*SendVerifyCodeReq)(nil),                      // 26: essay.show.SendVerifyCodeReq
	(*CreateExerciseReq)(nil),                      // 27: essay.show.CreateExerciseReq
	(*CreateExerciseResp)(nil),                     // 28: essay.show.CreateExerciseResp
	(*ListSimpleExercisesReq)(nil),                 // 29: essay.show.ListSimpleExercisesReq
	(*ListSimpleExercisesResp)(nil),                // 30: essay.show.ListSimpleExercisesResp
	(*GetExerciseReq)(nil),                         // 31: essay.show.GetExerciseReq
	(*GetExerciseResp)(nil),                        // 32: essay.show.GetExerciseResp
	(*DoExerciseReq)(nil),                          // 33: essay.show.DoExerciseReq
	(*DoExerciseResp)(nil),                         // 34: essay.show.DoExerciseResp
	(*LikeExerciseReq)(nil),                        // 35: essay.show.LikeExerciseReq
	(*Exercise)(nil),                               // 36: essay.show.Exercise
	(*Question)(nil),                               // 37: essay.show.Question
	(*ChoiceQuestion)(nil),                         // 38: essay.show.ChoiceQuestion
	(*Option)(nil),                                 // 39: essay.show.Option
	(*History)(nil),                                // 40: essay.show.History
	(*Records)(nil),                                // 41: essay.show.Records
	(*Record)(nil),                                 // 42: essay.show.Record
	(*SubmitFeedbackReq)(nil),                      // 43: essay.show.SubmitFeedbackReq
	(*SubmitFeedbackResp)(nil),                     // 44: essay.show.SubmitFeedbackResp
	(*GetUserFeedbacksReq)(nil),                    // 45: essay.show.GetUserFeedbacksReq
	(*FeedbackInfo)(nil),                           // 46: essay.show.FeedbackInfo
	(*GetUserFeedbacksResp)(nil),                   // 47: essay.show.GetUserFeedbacksResp
	(*GetFeedbackDetailReq)(nil),                   // 48: essay.show.GetFeedbackDetailReq
	(*GetFeedbackDetailResp)(nil),                  // 49: essay.show.GetFeedbackDetailResp
	(*UpdateFeedbackStatusReq)(nil),                // 50: essay.show.UpdateFeedbackStatusReq
	(*UpdateFeedbackStatusResp)(nil),               // 51: essay.show.UpdateFeedbackStatusResp
	(*ReplyFeedbackReq)(nil),                       // 52: essay.show.ReplyFeedbackReq
	(*ReplyFeedbackResp)(nil),                      // 53: essay.show.ReplyFeedbackResp
	(*GetAllFeedbacksReq)(nil),                     // 54: essay.show.GetAllFeedbacksReq
	(*GetAllFeedbacksResp)(nil),                    // 55: essay.show.GetAllFeedbacksResp
	(*GetUserInfoResp_Payload)(nil),                // 56: essay.show.GetUserInfoResp.Payload
	(*ListSimpleExercisesResp_Record)(nil),         // 57: essay.show.ListSimpleExercisesResp.Record
	(*ListSimpleExercisesResp_SimpleExercise)(nil), // 58: essay.show.ListSimpleExercisesResp.SimpleExercise
	(*DoExerciseReq_Record)(nil),                   // 59: essay.show.DoExerciseReq.Record
	(*basic.PaginationOptions)(nil),                // 60: basic.PaginationOptions
}
var file_essay_show_common_proto_depIdxs = []int32{
	56, // 0: essay.show.GetUserInfoResp.payload:type_name -> essay.show.GetUserInfoResp.Payload
	60, // 1: essay.show.GetEssayEvaluateLogsReq.paginationOptions:type_name -> basic.PaginationOptions
	20, // 2: essay.show.GetEssayEvaluateLogsResp.logs:type_name -> essay.show.Log
	36, // 3: essay.show.CreateExerciseResp.exercise:type_name -> essay.show.Exercise
	60, // 4: essay.show.ListSimpleExercisesReq.paginationOptions:type_name -> basic.PaginationOptions
	58, // 5: essay.show.ListSimpleExercisesResp.exercises:type_name -> essay.show.ListSimpleExercisesResp.SimpleExercise
	36, // 6: essay.show.GetExerciseResp.exercise:type_name -> essay.show.Exercise
	59, // 7: essay.show.DoExerciseReq.records:type_name -> essay.show.DoExerciseReq.Record
	41, // 8: essay.show.DoExerciseResp.records:type_name -> essay.show.Records
	37, // 9: essay.show.Exercise.question:type_name -> essay.show.Question
	40, // 10: essay.show.Exercise.history:type_name -> essay.show.History
	38, // 11: essay.show.Question.choiceQuestions:type_name -> essay.show.ChoiceQuestion
	39, // 12: essay.show.ChoiceQuestion.options:type_name -> essay.show.Option
	41, // 13: essay.show.History.records:type_name -> essay.show.Records
	42, // 14: essay.show.Records.records:type_name -> essay.show.Record
	46, // 15: essay.show.GetUserFeedbacksResp.feedbacks:type_name -> essay.show.FeedbackInfo
	46, // 16: essay.show.GetFeedbackDetailResp.feedback:type_name -> essay.show.FeedbackInfo
	46, // 17: essay.show.GetAllFeedbacksResp.feedbacks:type_name -> essay.show.FeedbackInfo
	57, // 18: essay.show.ListSimpleExercisesResp.SimpleExercise.records:type_name -> essay.show.ListSimpleExercisesResp.Record
...
func file_essay_show_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_essay_show_common_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubmitFeedbackResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserFeedbacksReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserFeedbacksResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[48].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetFeedbackDetailReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetFeedbackDetailResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateFeedbackStatusReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[51].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateFeedbackStatusResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplyFeedbackResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[54].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllFeedbacksReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_essay_show_common_proto_msgTypes[55].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllFeedbacksResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
